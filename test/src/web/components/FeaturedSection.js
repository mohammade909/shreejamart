  ...
  const trendingItems = [
    {
      ...
      originalPrice: 42.0,
      image:
        "https://grabit-next.tigerheck.com/assets/img/product-images/10_1.jpg",
    },
    {
      ...
      originalPrice: 25.0,
      image:
        "https://grabit-next.tigerheck.com/assets/img/product-images/11_1.jpg",
    },
    {
      ...
      originalPrice: 52.0,
      image:
        "https://grabit-next.tigerheck.com/assets/img/product-images/19_1.jpg",
    },
  ];
  ...
  const ratedItems = [
    {
      ...
      originalPrice: 62.0,
      image:
        "https://grabit-next.tigerheck.com/assets/img/product-images/17_1.jpg",
    },
    {
      ...
      originalPrice: 56.0,
      image:
        "https://grabit-next.tigerheck.com/assets/img/product-images/2_2.jpg",
    },
    {
      name: "Blue Berry",
      category: "Fruits",
      ...
      originalPrice: 25.0,
      image:
        "https://grabit-next.tigerheck.com/assets/img/product-images/23_1.jpg",
    },
  ];
  ...
  const sellingItems = [
    {
      ...
      originalPrice: 42.0,
      image:
        "https://grabit-next.tigerheck.com/assets/img/product-images/18_1.jpg",
    },
    {
      name: "Mango - Kesar",
      category: "Fruits",
      ...
      originalPrice: 62.0,
      image:
        "https://grabit-next.tigerheck.com/assets/img/product-images/28_1.jpg",
    },
    {
      name: "Mixed Nuts & Alm...",
      category: "Driedfruit",
      ...
      originalPrice: 10.0,
      image:
        "https://grabit-next.tigerheck.com/assets/img/product-images/7_2.jpg",
    },
  ];
  ...
  const ProductSection = ({ title, items }) => (
    <div className="w-full">
      <div className="flex justify-between items-center mb-10">
        <h2 className=" flex space-x-3 font-Poppins text-2xl text-primary/75 font-semibold">
    ...
    <div className="max-w-7xl mx-auto px-4  mt-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
        ...
        <div className="relative bg-gray-100 rounded-lg overflow-hidden">
          <img
            src="https://grabit-next.tigerheck.com/assets/img/banner/2.jpg"
            alt="Snack"
        ...
        <div className="relative bg-gray-100 rounded-lg overflow-hidden">
          <img
            src="https://grabit-next.tigerheck.com/assets/img/banner/3.jpg"
            alt="Fruits"
            className="w-full h-full object-cover"
          />
          <div className="absolute inset-0  flex flex-col justify-center items-end p-6 text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-5 mb-12 flex-col">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://grabit-next.tigerheck.com/assets/img/banner/4.jpg')",
          }}
        >
