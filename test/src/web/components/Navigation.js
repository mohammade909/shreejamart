          ...
          <div className="border-b border-gray-200">
            <div className="flex h-16 justify-between items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to="/">
                  <span className="sr-only">GrabIT</span>
                  <img
                    alt=""
                    src="/shreejamart.png"
              ...
              <div className="flex-1 hidden lg:block ml-6 max-w-md ">
                <form onSubmit={handleSearch} className="relative m-auto">
                  ...
                  <input
                    ...
                    className="block w-full px-4 py-3 text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 sm:text-sm"
                  />
                  <button
                    type="submit"
