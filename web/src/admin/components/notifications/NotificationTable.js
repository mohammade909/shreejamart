      ...
      <table className="min-w-full table-auto border-collapse border border-gray-400 bg-white text-sm">
        <thead>
          <tr className="bg-black text-gray-100 ">
            <th className="border border-gray-300 px-4 py-2 text-center font-medium">#</th>
            <th className="border border-gray-300 px-4 py-2 text-left font-medium">Title</th>
            <th className="border border-gray-300 px-4 py-2 text-left font-medium">Message</th>
            <th className="border border-gray-300 px-4 py-2 text-left font-medium">All User</th>
