  ...
  return (
    <>
      <div>
                  ...
                  {navigation.map((item) => (
                    <li key={item.name}>
                      {!item.children ? (
                        ...
                        //     item.current ? "bg-gray-900/50 border border-white/50 text-white"
                        //     : " text-gray-200 hover:bg-gray-900/50 hover:text-white",
                      ...
                      className={classNames(
                        item.name === activeTab
                          ? "bg-gray-900/50 border border-white/50 text-white"
                          : " text-gray-200 hover:bg-gray-900/50 hover:text-white",
                        "group flex w-full items-center gap-5 rounded-md py-2 pl-7 pr-2 text-sm font-medium"
                      )}
                    >
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 bg-black lg:flex lg:w-60 lg:flex-col ">
