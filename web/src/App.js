...
import VendorStore from "./web/pages/VendorStore";
import AdminSignIn from "./web/pages/AdminSignIn";
import SendMessage from "./SendMessage";
import ContactUs  from "./web/pages/Contact";
function App() {
  return (
    <Router>
      <ScrollToTop>
        <Routes>
          ...
          <Route element={<WebLayout />}>
            ...
            <Route path="/stores/vendor/:vendorId" element={<VendorStore />} />
            ...
            <Route path="/otp" element={<SendMessage />} />
          </Route>
        </Routes>
      </ScrollToTop>
    </Router>
