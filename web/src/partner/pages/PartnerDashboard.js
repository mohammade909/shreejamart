...
const DeliveryPartnerDashboard = () => {
  ...
  return (
    <Box className="p-3" sx={{ backgroundColor: "#f5f5f5", minHeight: "100vh" }}>
      {/* Header Section */}
      <Paper elevation={0} sx={{ p: 3, mb: 3, }} className="shadow-lg border-b-2 border-green-200">
        <Grid container alignItems="center" spacing={2}>
          ...
          <Grid item xs>
            <Typography variant="h6" className="capitalize" gutterBottom>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={4}>
          <Paper sx={{ p: 3, borderRadius: 2, height: "100%" }}>
            ...
            <Card sx={{ mb: 2 }}>
              <CardContent className="bg-blue-50 border-b-2 border-green-500">
