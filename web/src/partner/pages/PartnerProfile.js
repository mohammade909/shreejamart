...
const PartnerProfile = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex flex-col">
      ...
      {/* Profile Content */}
      <div className="container mx-auto px-4 py-8 grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4">
        {/* Personal Information Section */}
        <div className="bg-white/50 border border-blue-400 rounded-sm shadow-sm p-6 space-y-4">
          <Typography variant="h6" className="border-b border-blue-400 pb-2 flex items-center">
        ...
        <div className="bg-white/50 border border-indigo-400 rounded-sm shadow-sm p-6 space-y-4">
          <Typography variant="h6" className="border-b  border-indigo-400 pb-2 flex items-center">
        ...
        {/* Documents Section */}
        <div className="bg-white/50  border border-green-400 rounded-sm shadow-sm p-6 space-y-4">
          <Typography variant="h6" className="border-b border-green-400 pb-2 flex items-center">
