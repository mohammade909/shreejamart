...
import DeliveryOrdersModal from "../components/orders/RecentOrders";
...
const navigation = [
  {
    name: "Home",
    href: "/dashboard/delivery_partner",
    icon: BsShop,
    initial: "DAS",
    current: true,
    bgColor: "bg-blue-100",
...
export default function PartnerLayout() {
  ...
  const [open, setOpen] = useState(false); // Updated to use setOpen instead of onClose
  ...
  const fetchOrders = async () => {
    try {
      ...
      const response = await fetch(
        `${BASEURL}/api/v1/orders/recent-unassigned`
      );
      ...
      // This will now actually open the modal
    } catch (err) {
  ...
  return (
    <>
      {partner && partner?.partner_status === "active" && (
        <DeliveryOrdersModal
          open={open}
          onClose={setOpen}
          orders={orders}
      ...
      <div>
        ...
        >
          ...
          <div className="fixed inset-0 flex">
            ...
            >
              ...
              <div className="flex grow flex-col gap-y-5 bg-black overflow-y-auto px-6 pb-4 ring-1 ring-white/10">
        ...
        <div className="hidden lg:fixed bg-black lg:inset-y-0 lg:z-50 lg:flex lg:w-60 lg:flex-col ">
