                  ...
                  {Number(product.discount_percentage) > 0 ? (
                    <div className=" flex justify-between mb-4  text-primary capitalize text-2xl font-semibold ">
                      <div>
                        ...
                        <span className="text-secondary ml-2 text-xl">-{Number(product.discount_percentage).toFixed(0)}%</span>
                        <br />
                        <span className="text-gray-500 font-normal text-base line-through mt-3">
                          M.R.P. : {Number(product.original_price).toFixed(2)}
                        </span>
                      </div>
                      <div>
                        <span className="mb-3 text-lg">SKU# :78943KH</span>
                        <br />
                        <span
                          className={`${
                            Number(product?.stock_quantity) > 0
                              ...
                              : "text-red-200 "
                          } uppercase text-base font-normal tracking-wide`}
                        >
                          {Number(product?.stock_quantity) > 0
                            ? "In Stock"
                            : "Out of Stock"}
                    ...
                    <div className=" flex justify-between mb-4  text-primary capitalize text-2xl font-semibold ">
                      ...
                      <div>
                        <span className="text-lg">SKU# :78943KH</span>
                        <br />
                        <span className="text-secondary text-base font-normal">IN STOCK</span>
                      </div>
                    </div>
                  )}

                  <p
                    className="text-gray-700 break-all text-justify space-y-2  text-sm py-3"
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                {relatedProducts.map((product, index) => (
                  <div key={index} className="bg-white rounded-sm border border-gray-300 shadow ">
                    <img
                      src={product.image}
                      alt={product.title}
                      className="w-full h-48 object-cover rounded-lg mb-4  px-3 pt-4 "
                    />
                    <div className="px-3 py-4 border-t border-gray-300 ">
                    <h3 className="font-semibold mb-2 text-[14px]">{product.title}</h3>
